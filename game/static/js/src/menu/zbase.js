...
<div class = "wx_game_menu">
   <div class="wx_game_menu_field">
         <div class="wx_game_menu_field_item wx_game_menu_field_item_single">
            单人模式
         </div>
         <div class = "wx_game_menu_field_item wx_game_menu_field_item_multi">
            多人模式
         </div>
         <div class = "wx_game_menu_field_item wx_game_menu_field_item_settings">
            设置
         </div>
   </div>
</div>
